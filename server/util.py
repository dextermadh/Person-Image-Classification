...
def get_b64_test_image_vor_messi(): 
...
if __name__ == '__main__':
    ...
    # print(classify_image(get_b64_test_image_vor_messi(), None))
    print(classify_image(None, './test_images/lewa1.jpg'))
    print(classify_image(None, './test_images/messi1.jpg'))
    print(classify_image(None, './test_images/pedri1.jpg'))
    print(classify_image(None, './test_images/messi2.jpg'))
    print(classify_image(None, './test_images/messi3.jpg'))
